...
# read the excel
setwd("C:/Users/seema/OneDrive/Desktop/project/Youtube analysis/New folder")
channel_data = read_excel("youtube_fitness_data.xlsx") %>% 
  janitor::clean_names()
API_key = "AIzaSyDNVjF0sh5-5ySHCGisth5vS0NYDUlKTZI"
...
# function to loop through each channel id and put its info in a data
...
# extract a list of videos with its videoID and video published date
...
# loop through each channel and combine their videos info together
